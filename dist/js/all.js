...
define(['jquery'],function($){
    ...
    $p.on('mouseover',function(){console.log(123)
...
// 
        ...
        //右侧栏动画效果
        $rightli = $('#right-guide .fix li');
        // $fixl = $('#right-guide .fix span');
        // console.log($fixl);
        $rightli.on('mouseover',function(){
            console.log($(this).children('.fixl'));
            $(this).children('.fixl').css({'display':'block','border':'1px solid #F0F0F0','border-right':'none','overflow':'hidden','z-index':101,}).stop().animate({'right':40,'width':80,'border':'1px solid #F0F0F0'},100);
        });
        $rightli.on('mouseout',function(){
            $(this).children('.fixl').css({'display':'none',}).stop().animate({'right':40,'width':0,'border-right':'1px solid #F0F0F0'},100,function(){
...
require(['config'],function(){
    require(['jquery'],function($){console.log(124);
        // console.log('chenggong');
        //登录注册切换功能
        $form = $('.loginlist form');
        $tog = $('.loginlist .tog');
...
require(['config'],function(){
    require(['jquery'],function($){
        ...
        $frim = $('#firmPas');
        $vcode = $('.vcode');
        $cellphone.on('focus',function(){console.log(333);
            $('.tip1').text('请输入注册的手机号');
        }).on('blur',function(){
            $('.tip1').text('');
        });
        $pas.on('focus',function(){console.log(333);
            $('.tip2').text('6-20位字符,可使用字母、数字或字符的组合');
        }).on('blur',function(){
            $('.tip2').text('');
        });
        $frim.on('focus',function(){console.log(333);
            $('.tip3').text('请再次输入密码');
        }).on('blur',function(){
            $('.tip3').text('');
        });
        $vcode.on('focus',function(){console.log(333);
